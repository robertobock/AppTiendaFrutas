...
function Controller() {
    ...
    $.__views.winOne.add($.__views.view1);
    ...
    $.__views.view1.add($.__views.pedirFresa);
    ...
    $.__views.winTwo.add($.__views.view2);
    $.__views.pedirFresa = Ti.UI.createButton({
        layout: "vertical",
        title: "Pedir",
        id: "pedirFresa",
    ...
    $.__views.view2.add($.__views.pedirFresa);
    pedirUno ? $.__views.pedirFresa.addEventListener("click", pedirUno) : __defers["$.__views.pedirFresa!click!pedirUno"] = true;
    ...
    $.__views.winThre.add($.__views.view3);
    $.__views.pedirFresa = Ti.UI.createButton({
        layout: "vertical",
        title: "Pedir",
        id: "pedirFresa",
    ...
    $.__views.view3.add($.__views.pedirFresa);
    pedirUno ? $.__views.pedirFresa.addEventListener("click", pedirUno) : __defers["$.__views.pedirFresa!click!pedirUno"] = true;
